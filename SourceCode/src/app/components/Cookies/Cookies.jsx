      ...
      <div className="cookies main">
        <div className="main-fade" style={styles}>
          <div className="wrapper">
            ...
            <p>QuestCaster stores cookies and data in your browser to save your progress in the game and and to analyse our traffic. We will never save any personal information or sell your data. We will share information about your use of this site with Google Analytics.</p>
            ...
            <h2>Cookies</h2>
            <p>Cookies are text files containing small amounts of information which are downloaded onto your computer or device. The following are used on this site:</p>
