      ...
      <div className="main legend">
        <div className="main-fade" style={styles}>
          <div className="wrapper" style={styles}>
            <h1 className="legend-title">...it happened once upon a time</h1>
            ...
            <p><Link to='/login' className='landing-btn mdl-button mdl-js-button mdl-button--raised mdl-button--accent'><i className="material-icons">terrain</i> BEGIN QUEST </Link></p>
